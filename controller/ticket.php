<?php
    ...
    switch($_GET["op"]){
        case "insert":
            ...
            $datos=$ticket->insert_ticket($_POST["usu_id"],$_POST["id_nov"],$_POST["novedad"],$_POST["tick_descripcion"]);
        ...
        case "listar_x_usu":
            ...
            foreach($datos as $row){
                ...
                $sub_array [] = '<button type="button" onClick = "ver('.$row["tick_id"].');" id="'.$row["tick_id"].'" class="btn btn-inline-primary btn-info btn-sm ladda-button"><i class ="fa fa-eye"></i></button>';
                $data [] = $sub_array;
            }
                    ...
                    <header class="activity-line-item-header">
                        <div class="activity-line-item-user">
                            <div class="activity-line-item-user-photo">
                                <a href="#">
                                <img src="../Helpdesk/public/<?php echo $row["rol_id"] ?>.jpg" alt="">
                                </a>
                            </div>
