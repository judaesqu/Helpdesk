                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <fieldset class="form-group">
                            <label class="form-label semibold" for="div_nom">Division</label>
            ...
            <section class="activity-line" id="lbldetalle">
                    ...
                    <div class="box-typical box-typical-padding" id="pnldetalle">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <button type="button" class="btn btn-rounded btn-inline btn-primary" id="btnenviar">Enviar</button>
                                <button type="button" class="btn btn-rounded btn-inline btn-warning" id="btncerrarticket">Cerrar Ticket</button>
                            </div>
                        </div>
                    </div>
            </div>
